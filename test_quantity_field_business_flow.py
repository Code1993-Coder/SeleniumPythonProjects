...
def test_e2e(BrowserInstance, test_list_item):
    ...
    print("Checkout Page:Quantity Field Validation test")
    shop.dynamic_quantity_increment(test_list_item['product'], 3)
    checkout_obj=shop.go_to_cart()
    checkout_obj.quantity_decrement(test_list_item['product'])
    checkout_obj.price_evaluate(test_list_item['product'])
